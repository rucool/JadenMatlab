...
NDBC.WSPD=buoy01.DATA(ind,7);
[NDBC4.WSPD,idx2] = removeSpikes(NDBC.WSPD,2);
sum(idx2);

%% plot the despiked data
plot(CODAR3.time,CODAR9.MWPD,'g','LineWidth',2);
plot(CODAR3.time,CODAR3.MWPD,'b','LineWidth',2);
plot(NDBC.time,NDBC4.WSPD,'k','LineWidth',2);
...
legend('R7','R8','Buoy','AutoUpdate','off')
ylabel('Wave Period (s)')
format_axis(gca,dtime.start,dtime.end,3,1,'mm/dd',2,16,1)

timestamp(1,'/Users/Jaden Dicopoulos/Desktop/matlab/COMP_WavePeriod_R7_R8_NDBC.m')
