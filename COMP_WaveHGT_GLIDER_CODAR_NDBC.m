...
title('CODAR site SPRK R8 WP Buoy and Glider Wave Height for Hurricane Jose');
...
print('-dpng','-r250',[conf.print_path 'Hurricane_Jose_END_RU28_' buoy.name{indB} '_' codar.name{ii}...
