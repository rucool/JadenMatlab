...
title(['2017 Wave Period from R8 RC 2 ' codar.name{ii} ' Site']);
...
title('2017 R8 Comparison of Buoy and CODAR Wave Height at RC Averaged');
...
print('-dpng','-r350',[conf.print_path 'Wspd_Wdir_WVpd_WVht_R8_' buoy.name{indB}...
