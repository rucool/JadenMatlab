...
% and Buoy inputs, based on spectra
...
indS = spectra_days_vec(jj,2)==CODAR3_time_vec(:,2) & spectra_days_vec(jj,3)==CODAR3_time_vec(:,3);
new_codar=[new_codar;CODAR3.MWHT(indS)];
new_codar_time=[new_codar_time;CODAR3.time(indS)];

 
indS2 = spectra_days_vec(jj,2)==NDBC_time_vec(:,2) & spectra_days_vec(jj,3)==NDBC_time_vec(:,3);
...
buoy01i=interp1(new_ndbc_time,new_ndbc,spectra_days_hourly);
buoy02i=interp1(new_codar_time,new_codar,spectra_days_hourly);
% buoy01i=buoy01i';
