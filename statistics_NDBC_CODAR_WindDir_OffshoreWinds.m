...
ind_op = NDBC.WDIR<180 & NDBC.WDIR>60;
...
title('Wave Height from SPRK Range Cell 3 and Buoy 44065 Indexed by Offshore Winds 60° to 180°')
...
print('-dpng','-r150',[conf.print_path 'WaveHeightTS_WDIR_OffShoreWind_' buoy.name{indB} '_' codar.name{ii}...
...
title ('Significant Wave Height (m) Scatter Plot Indexed by Offshore Winds 60° to 180°')
box on
grid on
axis equal
axis([0 3 0 3] )
...
print('-dpng','-r150',[conf.print_path 'WaveHeightCorr_WDIR_OffshoreWind_' buoy.name{indB} '_' codar.name{ii}...
    '_' dtime.startSTR '_'  dtime.endSTR '.png'])
