function [Data]=Codar_WVM7_readin_func(datapath,file_extension)
...
for i=1:num_files
    ...
    STAT(:,13)=datenum(STAT(:,12),STAT(:,13),STAT(:,14),STAT(:,15),STAT(:,16),STAT(:,17));
...
Data.ACNT=WAVE_DATA(:,6);
Data.DIST=WAVE_DATA(:,7);
Data.RCLL=WAVE_DATA(:,8);
Data.time=WAVE_DATA(:,13);
